...
## 5. Projekti: Agent Squad (Top 5)
*   **Narratiivi:** Monen agentin tiimi myynnin, tutkimuksen ja tapaamisten valmistelun automatisointiin.
*   **Tekniset avainsanat:** FastAPI, React/Vite, multi-agent orchestration, Playwright, tool-calling.
*   **Highlight:** "Kolme erikoistunutta agenttia, jotka tekevät syväluotaavaa tutkimusta ja personoituja myyntikirjeitä täysin itsenäisesti."
...
| **Agent Squad** | **Vercel + HF Spaces** | Frontend Vercelissä, Backend Hugging Face Spacesissa (Docker). Kustannus: 0 €. |
...
---
**Tila:** Agent Squad on livenä. Muut projektit työn alla.
**Live-linkit:**
- **Agent Squad (Frontend):** [Vercel Deployment]
- **Agent Squad (Backend):** [Hugging Face Space]
